...
<div class="content-header">
  <div class="container">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><i class="icofont icofont-coins"></i> partner <small>List</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
          ...
          'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                    return '<img src="'.str_replace('/admin', '', Yii::getAlias('@web')).'/uploads/'.$model->partner_image_path.'/'.$model->partner_image.'" width="50">';
                },
            ],
            [
                'attribute' => 'partner_name_th',
                'label' => 'Partner Name (TH)',
                'format' => 'raw',
                // 'contentOptions' => ['style' => 'width:120px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->partner_name_th.'</div>';
                },
            ],
            [
                'attribute' => 'partner_name_en',
                'label' => 'Partner Name (EN)',
                'format' => 'raw',
                // 'contentOptions' => ['style' => 'width:120px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->partner_name_en.'</div>';
                },
            ],
            [
              ...
              'buttons'  => [
                'Update' => function ($url,$model) {
                  return Html::a('<span class="fa fa-edit" style="padding:0px 2px;"></span>','', [
                    ...
                    'title' => 'edit',
                    'data-toggle' => 'modal',
                    'value' => Url::to('partner/update/'.$model->partner_id),
                  ]);
                },
                'Delete' => function ($url, $model) {
                  return Html::a('<span class="fas fa-trash-alt" style="padding:0px 2px;"></span>', Url::to('partner/delete/'.$model->partner_id), [
                    'title' => 'delete',
                    'data-confirm' => Yii::t('yii', 'Are you sure you want to delete '.$model->partner_id.' this item?'),
                    'data-method'  => 'post',
                    'data-pjax' => 1
                  ]);
                },
