...
<div class="news-search">
    ...
    <div class="card card-outline card-info">
        <div class="card-header">
            ...
            <?= Html::button('<i class="icofont icofont-plus-circle"></i> Create News', ['value' => Url::to('news/create') , 'class' => 'btn btn-success btn-sm' , 'id'=>'btn-modal-create']) ?>
            </div>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div class="form-group-sm row">
                <div class="col-sm-6">
                    <label class="col-form-label-sm">News Name (TH)</label>
                    <?= $form->field($model, 'news_name_th')->textInput()?>
                </div>
                <div class="col-sm-6">
                    <label class="col-form-label-sm">News Name (EN)</label>
                    <?= $form->field($model, 'news_name_en')->textInput()?>
                </div>
            </div>
            <div class="form-group-sm row">
                <div class="col-sm-4">
                    <label class="col-form-label-sm">News Category</label>
                    <?= $form->field($model, 'news_category')->dropDownList($NewsCategory,['class'=>'form-control form-control-sm select2']); ?>
                </div>
                <div class="col-sm-4">
