...
<div class="content-header">
  <div class="container">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><i class="icofont icofont-coins"></i> News <small>List</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<div class="content">
  <div class="container">
    ...
    <?= $this->render('_search', ['model'=> $model,'search' => $search,'NewsCategory'=>$NewsCategory]); ?>
          ...
          'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                    return '<img src="'.str_replace('/admin', '', Yii::getAlias('@web')).'/uploads/'.$model->news_image_path.'/'.$model->news_image.'" width="50">';
                },
            ],
            [
                ...
                'value' => function ($model) {
                  return (empty($model->newsCategory->news_category_name_th) ? null : '<div style="height: 25px;overflow:hidden;">'.$model->newsCategory->news_category_name_th.'</div>');
                },
            ],
            [
                'attribute' => 'news_name_th',
                'label' => 'News Name (TH)',
                'format' => 'raw',
                // 'contentOptions' => ['style' => 'width:120px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->news_name_th.'</div>';
                },
            ],
            [
                'attribute' => 'news_name_en',
                'label' => 'News Name (EN)',
                'format' => 'raw',
                // 'contentOptions' => ['style' => 'width:120px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->news_name_en.'</div>';
                },
            ],
            [
              ...
              'buttons'  => [
                'Update' => function ($url,$model) {
                  return Html::a('<span class="fa fa-edit" style="padding:0px 2px;"></span>','', [
                    ...
                    'title' => 'edit',
                    'data-toggle' => 'modal',
                    'value' => Url::to('news/update/'.$model->news_id),
                  ]);
                },
                'Delete' => function ($url, $model) {
                  return Html::a('<span class="fas fa-trash-alt" style="padding:0px 2px;"></span>', Url::to('news/delete/'.$model->news_id), [
                    'title' => 'delete',
                    'data-confirm' => Yii::t('yii', 'Are you sure you want to delete '.$model->news_id.' this item?'),
                    'data-method'  => 'post',
                    'data-pjax' => 1
                  ]);
                },
