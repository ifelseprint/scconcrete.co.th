...
<div class="portfolio-search">
    ...
    <div class="card card-outline card-info">
        <div class="card-header">
            ...
            <?= Html::button('<i class="icofont icofont-plus-circle"></i> Create Portfolio', ['value' => Url::to('portfolio/create') , 'class' => 'btn btn-success btn-sm' , 'id'=>'btn-modal-create']) ?>
            </div>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div class="form-group-sm row">
                <div class="col-sm-3">
                    <label class="col-form-label-sm">Portfolio Name (TH)</label>
                    <?= $form->field($model, 'portfolio_name_th')->textInput()?>
                </div>
                <div class="col-sm-3">
                    <label class="col-form-label-sm">Portfolio Name (EN)</label>
                    <?= $form->field($model, 'portfolio_name_en')->textInput()?>
                </div>
                <div class="col-sm-3">
