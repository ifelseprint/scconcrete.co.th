    ...
    p._tinymce = function () {
        ...
        $.getJSON("filemanager/config", function(config) {
            ...
            tinymce.init({
                ...
                convert_urls:false,
                relative_urls:true,
                plugins: 'paste image code table fullscreen',
                toolbar: 'fullscreen | undo redo | styleselect | fontsizeselect  | forecolor | bold italic | alignleft aligncenter alignright alignjustify | outdent indent | link image | code',
