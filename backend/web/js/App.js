    ...
    p._tinymce = function () {
        ...
        $.getJSON("filemanager/config", function(config) {
            ...
            tinymce.init({
                ...
                convert_urls:false,
                relative_urls:true,
                plugins: 'paste image code table fullscreen textcolor',
                toolbar: 'fullscreen | undo redo | styleselect | fontsizeselect  | forecolor backcolor | bold italic | alignleft aligncenter alignright alignjustify | outdent indent | link image | code',
